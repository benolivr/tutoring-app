    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_name",
                    models.CharField(help_text="Last name of the tutor", max_length=50),
                ),
                (
                    "first_name",
                    models.CharField(
                        help_text="First name of the tutor", max_length=50
                    ),
                ),
                (
                    "tutor_email",
                    models.EmailField(
                        help_text="Student email address of the tutor",
                        max_length=254,
                        unique=True,
                    ),
                ),
